...
# Importing modules
from struct_train import model_train_batch, model_train
...
if batchnorm:
    train, train_std, val, val_std, epoch_tot, time, epoch_best = model_train_batch(augment, cuda, load_model, save_model, loss_type, N_patients, N_val, weights, patience, stopping_tol, limit, monitor)
else:
