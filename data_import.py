...
def input_data(N):
    ...
    with open(r'C:\Users\thijs\Documents\master applied physics\mep\Thierry_Cleaned_scripts\Lists\patient_IDs.txt') as f:                             #Location of list with patient IDs
        patIDs = [line.rstrip()[1:-1] for line in f]
    patID = patIDs[N]
    struc_list = r'C:\Users\thijs\Documents\master applied physics\mep\Thierry_Cleaned_scripts\Lists\Structures.txt'    #Location of list with structures
    PTV_struct = r'C:\Users\thijs\Documents\master applied physics\mep\Thierry_Cleaned_scripts\Lists\PTV.txt'           #Location of list with PTV names
